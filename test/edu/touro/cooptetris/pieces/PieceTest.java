...
public class PieceTest {
	...
	public void testCollidesWith() {
		BoxPiece aBox = new BoxPiece(0, 0, 1, 0);
		LinePiece aLine = new LinePiece(0, 0, 2, 0);
	...
	public void testMoveLeft() {
		SPiece anSPiece = new SPiece(0, 0, 1, 0);
		...
		Assert.assertEquals(15, squares[2].getY());
	...
	public void testMoveRight() {
		...
		Assert.assertEquals(15, squares[1].getX());
		Assert.assertEquals(15, squares[1].getY());
		Assert.assertEquals(15, squares[2].getX());
